            ...
            <table style={{ width: "100%", borderCollapse: "collapse", textAlign: "left", tableLayout: "fixed" }}>
              ...
              <tbody>
                {filtered.map((r) => {
                  ...
                  // Check if they have filled out ANY stealth field
                  ...
                  return (
                    <tr key={r.id} style={{ borderBottom: "1px solid #f1f5f9" }}>
                      ...
                      <td style={{ padding: "16px 20px", verticalAlign: "top" }}>
                        <div style={{ fontWeight: 600, color: indigo, fontSize: "14px" }}>
                          {cc.target_role || "Role Not Set"}
                        </div>
                        <div style={{ fontSize: "12px", color: "#64748b" }}>
                          {cc.years_experience || 0} Yrs • {cc.location_blurb || r.city || "Remote"}
                        </div>
                      </td>
                            ...
                            return (
                              <div
                                ...
                                style={{
                                  ...
                                  alignItems: "center",
                                  fontSize: "11px",
                                  background: item.visible_to_client ? "#f0fdf4" : "#f8fafc",
                                  padding: "8px 12px",
                                  borderRadius: "10px",
                                  border: `1px solid ${item.visible_to_client ? "#bbf7d0" : "#e2e8f0"}`,
                                }}
                              >
                                <div
                                ...
                                >
                                  <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
                                    ...
                                    >
                                      {job?.companies?.name || "Job"}: {job?.title}
                                    </span>
                                  </div>
                                  <div style={{ fontSize: "10px", color: "#94a3b8", fontWeight: 500, paddingLeft: "20px" }}>
                                    {city} • {repName}
                                  </div>
                                </div>

                                <form
                                  action="/api/admin/job-tank/remove"
                                  method="POST"
                      ...
                      <td style={{ padding: "16px 20px", verticalAlign: "top" }}>
                        <span
                          style={{
                            ...
                            fontSize: "10px",
                            fontWeight: 800,
                            background: r.stealth_mode ? "#fffbeb" : "#f0fdf4",
                            color: r.stealth_mode ? "#92400e" : "#166534",
                          }}
                        >
                          {r.stealth_mode ? "STEALTH" : "ACTIVE"}
                        </span>
                      </td>
